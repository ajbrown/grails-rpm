...
class GrailsRpmPluginGrailsPlugin {
    // the plugin version
    def version = "0.1"
    ...
    def title = "Grails Rpm Build Plugin" // Headline display name of the plugin
...
This plugin allows the packaging of your grails application as an RPM which can be installed and run on your server.
 It leverages the standalone
'''

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/grails-rpm-plugin"
